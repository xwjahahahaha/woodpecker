...
var _ sdk.Msg = &MsgCreateBodyIndex{}

type MsgCreateBodyIndex struct {
...
func (msg MsgCreateBodyIndex) Route() string {
  return RouterKey
}

func (msg MsgCreateBodyIndex) Type() string {
  return "CreateBodyIndex"
}

func (msg MsgCreateBodyIndex) GetSigners() []sdk.AccAddress {
  return []sdk.AccAddress{sdk.AccAddress(msg.Creator)}
}

func (msg MsgCreateBodyIndex) GetSignBytes() []byte {
  bz := ModuleCdc.MustMarshalJSON(msg)
  return sdk.MustSortJSON(bz)
}

func (msg MsgCreateBodyIndex) ValidateBasic() error {
